...
.club-chart-switch button.is-on,
...
`;
    ...
    return `
      <div class="club-countdowns">
        ...
        <div class="club-countdown">
          ...
          <span class="club-countdown-label">
            次の公式記録
          </span>

          <strong class="club-countdown-value">
            ${officialValue}
          </strong>

          <span class="club-countdown-sub">
            ${officialSub}
          </span>
  ...
  function effectiveCampaignDate() {
      ...
      <div class="club-shell">
        ...
        <section class="club-section">
          ...
          <div class="club-section-head">
            ...
            <div>
              ...
              <p
                class="club-section-note"
                id="clubChartNote"
              >
                9/1以降の最初の計測を基準にした累計減量
              </p>
        ...
        <section class="club-section">
          ...
          <div class="club-section-head">
            ...
            <div
              class="club-top-switch"
              role="tablist"
              aria-label="TOP5の表示切り替え"
            >
